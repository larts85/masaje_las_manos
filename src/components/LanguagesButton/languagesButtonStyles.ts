const className = {
  ...
  languageButton:
    'flex flex-wrap gap-[1.5vw] hover:cursor-pointer bg-primary-base items-center rounded-[100px] relative top-[0px] z-30 justify-center w-full h-[10px] sm:h-[17px] md:h-[20px] xl:h-[1.6vw] xl:gap-[2vw] ',
  languageText:
