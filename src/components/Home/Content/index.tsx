...
const HomeBoddy: FC = () => {
  return (
    <div className="relative">
      ...
      <p className="absolute z-10 top-[75vw] left-[3vw] w-[205px] font-jost text-right text-[8px] font-normal leading-tight">
      ...
      <p className="absolute z-10 top-[150vw] right-[2vw] w-[170px] h-[200px] flex-shrink-0 font-jost text-left text-[8px] font-normal leading-tight overflow-hidden text-ellipsis">
      ...
      <p className="absolute z-10 top-[230vw] left-[5vw] w-[170px] flex-shrink-0 font-jost text-left text-[8px] font-normal leading-tight">
