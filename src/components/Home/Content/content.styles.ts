...
const className = {
  ...
  sesionTwo: `relative left-[15vw] ${sesionTwoSize.movile}`,
  ...
  list: `flex-shrink-0 relative text-left font-normal leading-tight overflow-hidden text-ellipsis left-[6vw] ${listSize.movile} ${listSize.sm} ${listSize.md} ${listSize.lg} ${listSize.xl}`,
